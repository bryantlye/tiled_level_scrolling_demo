...
game.getResourceManager().loadScene(DESERT_SCENE_PATH, game.getSceneGraph(), game.getRenderingSystem(), function () {
    ...
    for (var i = 0; i < 100; i++) {
        ...
        var randomSprite = new AnimatedSprite_1.AnimatedSprite(_type, "WALKING");
        if (i >= 50) {
            _type = game.getResourceManager().getAnimatedSpriteType("PRAYING_MANTIS");
            randomSprite = new AnimatedSprite_1.AnimatedSprite(_type, "WALK");
        }
    ...
    var type = game.getResourceManager().getAnimatedSpriteType("FIREFLY");
    var playerSprite = new AnimatedSprite_1.AnimatedSprite(type, "WALKING1");
    var sceneGraph = game.getSceneGraph();
    var startX = sceneGraph.getViewport().getWidth() / 2;
    var startY = sceneGraph.getViewport().getHeight() / 2;
    playerSprite.getPosition().set(startX, startY, 0, 1);
...
var LadybugBehavior = function (_Behavior_1$Behavior) {
    _inherits(LadybugBehavior, _Behavior_1$Behavior);

    function LadybugBehavior() {
        _classCallCheck(this, LadybugBehavior);

        var _this = _possibleConstructorReturn(this, (LadybugBehavior.__proto__ || Object.getPrototypeOf(LadybugBehavior)).call(this));
    ...
    _createClass(LadybugBehavior, [{
        key: "update",
        value: function update(pos) {
            if (this.frameCounter < this.distance) {
                var spriteY = pos.getY();
                pos.set(pos.getX(), spriteY + this.y, pos.getZ(), pos.getW());
            } else {
                this.frameCounter = 0;
                this.y = -this.y;
            }
...
exports.LadybugBehavior = LadybugBehavior;

},{"./Behavior":3}],5:[function(require,module,exports){
"use strict";
...
var MantisBehavior = function (_Behavior_1$Behavior) {
    _inherits(MantisBehavior, _Behavior_1$Behavior);

    function MantisBehavior() {
        _classCallCheck(this, MantisBehavior);

        var _this = _possibleConstructorReturn(this, (MantisBehavior.__proto__ || Object.getPrototypeOf(MantisBehavior)).call(this));

        _this.scale = 200;
        _this.distance = Math.floor(Math.random() * _this.scale);
        _this.x = Math.random() * 2 - 1;
        _this.y = Math.random() * 2 - 1;
        return _this;
    }

    _createClass(MantisBehavior, [{
        key: "update",
        value: function update(pos) {
            if (this.frameCounter < this.distance) {
                var spriteX = pos.getX();
                var spriteY = pos.getY();
                pos.set(spriteX + this.x, spriteY + this.y, pos.getZ(), pos.getW());
            } else {
                this.frameCounter = 0;
    ...
    return MantisBehavior;
}(Behavior_1.Behavior);

exports.MantisBehavior = MantisBehavior;

},{"./Behavior":3}],6:[function(require,module,exports){
"use strict";
...
var PlayerBehavior = function (_Behavior_1$Behavior) {
    _inherits(PlayerBehavior, _Behavior_1$Behavior);

    function PlayerBehavior() {
        _classCallCheck(this, PlayerBehavior);

        var _this = _possibleConstructorReturn(this, (PlayerBehavior.__proto__ || Object.getPrototypeOf(PlayerBehavior)).call(this));
    ...
    _createClass(PlayerBehavior, [{
        key: "update",
        value: function update(pos, offX, offY) {
            var spriteX = pos.getX();
            var spriteY = pos.getY();
            var incX = 0;
            var incY = 0;
            ...
            pos.set(spriteX + incX, spriteY + incY, pos.getZ(), pos.getW());
        }
    }]);
...
},{"./Behavior":3}],7:[function(require,module,exports){
"use strict";
        ...
        value: function getPlayerSprite() {
            ...
            try {
                for (var _iterator2 = this.animatedSprites[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (sprite.getState() == "WALKING1") return sprite;
                }
            } catch (err) {
...
var Viewport = function () {
    ...
    _createClass(Viewport, [{
        ...
        value: function contains(pointX, pointY) {
            var vpLeft = this.x;
            var vpRight = this.x + this.width;
            var vpTop = this.y;
            var vpBottom = this.y + this.height;
            if (pointX < vpLeft || vpRight < pointX || pointY < vpTop || vpBottom < pointY) {
                return false;
            } else {
                return true;
            }
...
var LadybugBehavior_1 = require("../../ai/LadybugBehavior");
var MantisBehavior_1 = require("../../ai/MantisBehavior");
var PlayerBehavior_1 = require("../../ai/PlayerBehavior");
...
var AnimatedSprite = function (_SceneObject_1$SceneO) {
    ...
    function AnimatedSprite(initSpriteType, initState) {
        ...
        if (initState == "WALKING") {
            _this.behavior = new LadybugBehavior_1.LadybugBehavior();
        } else if (initState == "WALK") {
            _this.behavior = new MantisBehavior_1.MantisBehavior();
        } else {
            _this.behavior = new PlayerBehavior_1.PlayerBehavior();
        }
        // START RESET
...
},{"../../ai/LadybugBehavior":4,"../../ai/MantisBehavior":5,"../../ai/PlayerBehavior":6,"../SceneObject":20}],23:[function(require,module,exports){
"use strict";
...
var UIController = function UIController(canvasId, initScene) {
    ...
    this.mouseDownHandler = function (event) {
        ...
        var sprite = _this.scene.getSpriteAt(mousePressX + vp.getX(), mousePressY + vp.getY());
    ...
    this.mouseMoveHandler = function (event) {
        ...
        var player = _this.scene.getPlayerSprite();
        var c_behavior = player.getBehavior();
